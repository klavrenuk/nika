  ...
  <div class="app-cookie-banner" v-if="isShowContent">
    ...
    <div class="app-cookie-banner__container">
      <p class="app-cookie-banner__text">
        ООО "Ника" обрабатывает cookies с целью персонализации сервисов, и чтобы пользоваться веб-сайтом было удобнее. Вы можете запретить обработку сookies в настройках браузера. Пожалуйста, ознакомьтесь с <a href="/docs/nika-partners.ru - Политика использования cookie-файлов.pdf" download="Политика использования cookie-файлов">политикой использования cookies</a>. Читайте подробнее, как ООО "Ника" защищает ваши персональные данные.
      </p>
