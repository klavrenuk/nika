...
<template>
  <div class="about-right d-flex flex-column">
    ...
    <p class="about-right__text">
      Мы специализируемся на оптовых поставках керамики и керамогранита для жилых, коммерческих и общественных
      помещений. Прямые поставки по Югу России, ЛНР и ДНР.
    </p>

    <div class="d-flex flex-column about-right__wrap-text">
      <p class="about-right__text text-white text-middle">
        Осуществляем поставки в Ростов‑на‑Дону, Краснодарский край, ЛНР и ДНР для жилых комплексов, коттеджных посёлков,
        а также коммерческих и общественных объектов — от фасадов и террас до интерьеров ресторанов, школ и
        супермаркетов. Работаем с бюджетными учреждениями, имеем специальные счета.
      </p>
      <p class="about-right__text">
