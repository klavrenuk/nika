  ...
  <div class="founder-person d-flex flex-column" ref="founderBlock">
    ...
    <div class="founder-person__bottom d-flex flex-column">
      ...
      <p class="founder-person__description">
        Я сам прошел путь от обычного продавца до руководителя собственного предприятия и знаю, как важно, чтобы всё
        было в срок и без сбоев. Поэтому каждый объект я контролирую лично — от заявки до последней поставки. Это — мой
        подход, и он остаётся неизменным уже более 20 лет.
        Весь свой опыт и экспертные знания я передаю своей профессиональной команде . Мои принципы честного и
        взаимовыгодного партнерства , клиентоориентированности, долгосрочных отношений теперь стали приоритетами всей
        организации.
      </p>
    </div>
  </div>
